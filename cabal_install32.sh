...
clear
  ...
  echo -en "\n\033[0;33mRequired OS version: CentOS 6.4 32bit(i686)\033[0m" 
  echo -e "\n\033[0;33mYour OS version: $(cat /etc/centos-release) $(uname -m)\033[0m"
   ...
   if [[ -z $ready || $ready == "y" || $ready == "Y" ]]; then
      ...
      cp --force /root/rpm-install32/CentOS-Base.repo /etc/yum.repos.d/
      rpm --force --nodeps -Uvh --nosignature /root/rpm-install32/openssl097a-0.9.7a-9.i686.rpm
      rpm --force --nodeps -Uvh --nosignature /root/rpm-install32/openssl098e-0.9.8e-17.el6.centos.2.i686.rpm
      rpm --force --nodeps -Uvh --nosignature /root/rpm-install32/Packages/*
      rpm --force --nodeps -Uvh --nosignature /root/rpm-install32/freetds-0.64-1.el6.rf.i686.rpm
   fi
...
chkconfig udev-post off
      ...
      cp --force /root/rpm-install32/original_CentOS-Base.repo/CentOS-Base.repo /etc/yum.repos.d/
